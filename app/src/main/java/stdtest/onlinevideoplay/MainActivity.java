package stdtest.onlinevideoplay;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String uriPath = "http://coxtunes.com/client_mobile_app_project/onlineorder/captaincox/api/usermanual.mp4"; //update package name
...
//                vv.start();
    ...
    {
        Intent a = new Intent(MainActivity.this, Youtube.class);
        startActivity(a);
